...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        if i % 50 == 0:
            ...
            vutils.save_image(fake, os.path.join(f'images/{cat_id}', f'yt_{epoch}_{i}.png'))
        ...
        iters += 1
    torch.save(netD.state_dict(),f'model/{cat_id}_D')
    torch.save(netG.state_dict(),f'model/{cat_id}_G')
...
plt.legend()
plt.show()
plt.savefig('fig/G&D_Loss.png', dpi=300)
...
plt.savefig('fig/real_img.png', dpi=300)
...
plt.show()
plt.savefig('fig/fake_img_last_epoch.png', dpi=300)
"""Where to Go Next
----------------
